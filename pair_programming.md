...
- **Order** — заказ
- **User** — пользователь
- **Cart** — корзина.                                                                                                                                             Во время выполнения задания были опробованы два метода парного программирования:
  «на равных»
  «пинг-понг»
---
## 2. Сравнение применяемых стилей
По итогам работы более удобным оказался стиль **«на равных»**. В этом формате оба участника активно участвуют в принятии решений, обсуждают архитектуру и по очереди меняются ролями. Смена «водителя» происходила после завершения логических частей кода, что было естественно и удобно. Стиль **«пинг-понг»** оказался полезным при работе по принципу TDD (сначала тест — потом реализация). Однако на практике он замедлял процесс, так как требовал постоянного написания тестов и строгого соблюдения очередности ролей. Из-за непривычности такого формата темп разработки снижался.
